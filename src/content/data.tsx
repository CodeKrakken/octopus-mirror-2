...
const demoVoices = [
  {
    ...
    isActive: true,
    label: "kick",
    nextInterval: 1319.0019274376418,
    bpm: 120,
    minLevel: 100,
    maxLevel: 100,
    ...
    minDecay: 0,
    maxDecay: 0,
    thisInterval: 1318.5019274376418,
    offsetInterval: 266.8710430839002,
  },
  {
    id: "9cda77a4-04ea-484c-baf4-2e4c8ba9736c",
    isActive: true,
    label: "snare",
    nextInterval: 1319.7519274376418,
    bpm: 120,
    minLevel: 100,
    maxLevel: 100,
    activeNotes: ["1", "6", "8", "13", "11"],
    ...
    minDecay: 0,
    maxDecay: 0,
    thisInterval: 1318.7519274376418,
    offsetInterval: 286.9960430839002,
  },
  {
    ...
    minDecay: 100,
    maxDecay: 100,
    thisInterval: 1318.8769274376418,
    offsetInterval: 33.121043083900226,
  },
  {
  ...
  },
  {
    ...
    isActive: true,
    label: "hi hat",
    nextInterval: 1319.2519274376418,
    bpm: 120,
    minLevel: 48,
    maxLevel: 49,
    activeNotes: ["1", "6", "8", "13", "11"],
    ...
    maxDecay: 100,
    thisInterval: 1318.7519274376418,
    offsetInterval: 978.9056009070295,
  },
  {
    ...
    maxDecay: 0,
    thisInterval: 1318.8769274376418,
    offsetInterval: 1318.8769274376418,
  },
    {
    ...
    maxDecay: 100,
    thisInterval: 1318.7519274376418,
    offsetInterval: 1318.7519274376418,
  },
  {
